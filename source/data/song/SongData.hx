...
class SongMetadata
{
    ...
    **/
    ...
    public function new(songName:String, composers:Array<String>, artists:Array<String>, charters:Array<String>, coders:Array<String>, keyCount:Int)
    {

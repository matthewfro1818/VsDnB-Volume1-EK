...
class Character extends FlxSprite implements IRegistryEntry<CharacterData> implements IPlayStateScriptedClass
{
	...
	public function sing(direction:Int, ?miss:Bool = false, ?alt:String = '', ?singArray:Array<String>)
	{
		if (singArray == null) 
			...
			{
				case 5: singArray = ['LEFT', 'DOWN', 'UP', 'UP', 'RIGHT'];
				case 6: singArray = ['LEFT', 'UP', 'RIGHT', 'LEFT', 'DOWN', 'RIGHT'];
                case 7: singArray = ['LEFT', 'UP', 'RIGHT', 'UP', 'LEFT', 'DOWN', 'RIGHT'];
				case 8: singArray = ['LEFT', 'DOWN', 'UP', 'RIGHT', 'LEFT', 'DOWN', 'UP', 'RIGHT'];
				case 9: singArray = ['LEFT', 'DOWN', 'UP', 'RIGHT', 'UP', 'LEFT', 'DOWN', 'UP', 'RIGHT'];
				case 12: singArray = ['LEFT', 'DOWN', 'UP', 'RIGHT', 'LEFT', 'DOWN', 'UP', 'RIGHT', 'LEFT', 'DOWN', 'UP', 'RIGHT'];
			    default: singArray = ['LEFT', 'DOWN', 'UP', 'RIGHT'];
			}
	...
	{
		return (PlayerSettings.controls.LEFT || PlayerSettings.controls.DOWN || PlayerSettings.controls.UP || PlayerSettings.controls.RIGHT || PlayerSettings.controls.SECOND_LEFT || PlayerSettings.controls.SECOND_DOWN || PlayerSettings.controls.SECOND_UP || PlayerSettings.controls.SECOND_RIGHT || PlayerSettings.controls.THIRD_LEFT || PlayerSettings.controls.THIRD_DOWN || PlayerSettings.controls.THIRD_UP || PlayerSettings.controls.THIRD_RIGHT);
	}
	...
	{
		return (PlayerSettings.controls.LEFT_P || PlayerSettings.controls.DOWN_P || PlayerSettings.controls.UP_P || PlayerSettings.controls.RIGHT_P || PlayerSettings.controls.SECOND_LEFT_P || PlayerSettings.controls.SECOND_DOWN_P || PlayerSettings.controls.SECOND_UP_P || PlayerSettings.controls.SECOND_RIGHT_P || PlayerSettings.controls.THIRD_LEFT_P || PlayerSettings.controls.THIRD_DOWN_P || PlayerSettings.controls.THIRD_UP_P || PlayerSettings.controls.THIRD_RIGHT_P);
	}

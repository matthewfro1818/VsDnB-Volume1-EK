...
{
	/**
	 * The default color directions for 6-key notes.
	 */
	...
	function buildNoteGraphic(noteStyle:NoteStyle)
	{
		...
		{
			case 5: COLOR_DIRECTIONS = ['purple', 'blue', 'white', 'green', 'red'];
			case 6: COLOR_DIRECTIONS = ['purple', 'green', 'red', 'yellow', 'blue', 'cobalt'];
			case 7: COLOR_DIRECTIONS = ['purple', 'green', 'red', 'white', 'yellow', 'violet', 'cobalt'];
			case 8: COLOR_DIRECTIONS = ['purple', 'blue', 'green', 'red', 'yellow', 'violet', 'crimson', 'cobalt'];
			case 9: COLOR_DIRECTIONS = ['purple', 'blue', 'green', 'red', 'white', 'yellow', 'violet', 'crimson', 'cobalt'];
			case 12: COLOR_DIRECTIONS = ['purple', 'blue', 'green', 'red', 'pink', 'turq', 'emerald', 'lightred', 'yellow', 'violet', 'crimson', 'cobalt'];
			default: COLOR_DIRECTIONS = ['purple', 'blue', 'green', 'red'];
		}
